...
class ProductListViewModel {
    ...
    func fetchProducts(query: String, completion: @escaping (Swift.Result<[Result], Error>) -> Void) {
        ...
        APIClient.shared.fetchData(urlString: "https://api.mercadolibre.com/sites/MLC/search", objectType: ProductListModel.self, method: .get, parameters: ["q" : query]) { result in
            switch result {
